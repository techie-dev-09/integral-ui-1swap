...
const Algebra = () => <div className="flex items-center gap-2">
    <NavLink to={'/'}>
        <div className="flex items-center gap-2 py-1 pl-2 bg-card rounded-3xl hover:bg-card-hover duration-200">
            ...
            <img className="hidden md:block mt-1" src={AlgebraIntegral} width={80} height={25}  style={{ height:"25px" }}/>
        </div>
    </NavLink>
</div>
